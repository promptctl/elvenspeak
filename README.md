...
Nothing is synthesized at this gate, so cpu costs nothing here.
...
design while the smoke waits for 200. That second container is `piper-build-b4h.4`. Running it confined would prove the
